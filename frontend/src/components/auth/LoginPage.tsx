      ...
      <div className="w-full max-w-md rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        {authStatus?.mode === "production" && (
          <div className="login-buttons space-y-3">
            ...
            >
              <GoogleIcon />
              <span className="ml-2">Login mit Google</span>
            </Button>
            <Button
              variant="outline"
              className="w-full border-slate-300 bg-white hover:bg-slate-50"
            ...
            >
              <MicrosoftIcon />
              <span className="ml-2">Login mit Microsoft</span>
            </Button>
            <p className="hint mt-4 text-center text-xs text-slate-500">
              Für Institutionen: Login mit Ihrem institutionellen Account (Azure
              AD, DFN-AAI, ELIXIR AAI)
            </p>
          </div>
        )}
